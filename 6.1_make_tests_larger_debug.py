...
parser.add_argument("--full", action="store_false", help="Use the full dataset instead of the sample dataset.")
...
# Save the tests
with open(f"data/tests/dvb_tests_debug{suffix}.json", "w") as f:
    json.dump(tests, f, indent=2)

# Save all prompts
with open(f"data/tests/dvb_all_prompts_debug{suffix}.json", "w") as f:
    json.dump(all_prompts, f, indent=2)


# SAMPLES
#######################################
sample_size = min(40, len(all_prompts))
sample_prompts = random.sample(all_prompts, sample_size)

with open(f"data/tests/dvb_sample_prompts_debug{suffix}.json", "w") as f:
    json.dump(sample_prompts, f, indent=2)

with open(f"debug_tests_debug{suffix}.md", "w") as md_file:
...
print(f"All {len(sample_prompts)} prompts have been written to debug_tests_debug{suffix}.md")